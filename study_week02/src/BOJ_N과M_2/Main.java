...
public class Main {
    ...
    private static void comb(int n, int m, List<Integer> current, List<List<Integer>> output, int start ) {
        if(current.size() == m) {
